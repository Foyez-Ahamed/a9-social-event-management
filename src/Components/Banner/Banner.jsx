...
const Banner = () => {
    return (
     ...
     <div className="hero min-h-screen" style={{backgroundImage: 'url(https://i.ibb.co/JqGrrK3/decorated-banquet-hall-with-served-round-table-with-hydrangea-centerpiece-chiavari-chairs-1.jpg)'}}>
     <div className="hero-overlay bg-opacity-60"></div>
     <div className="hero-content text-center text-neutral-content">
    <div className="max-w-md">
      <h1 className="mb-5 text-4xl font-bold text-white">Make your event stand out from the best!</h1>

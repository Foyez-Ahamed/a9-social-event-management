...
<input type= "Text"
 placeholder="enter your name..." name="name" required className=" mt-4 mb-4 input bg-[#F3F3F3] w-[320px] md:w-[390px] lg:w-[390px]" /> <br />

 <label htmlFor="photoURL">Photo URL</label> <br /> 
<input type= "text"
 placeholder="Photo URL..." name="photoURL" required className=" mt-4 mb-4 input bg-[#F3F3F3] w-[320px] md:w-[390px] lg:w-[390px]" /> <br />    
...
<input type="submit" value= "Register" className=" btn w-[320px] md:w-[390px] lg:w-[390px] mt-5 font-bold bg-[#FF900E] text-white hover:bg-gray-600" />
</div>

...
<footer className="footer footer-center p-10 bg-base-100 shadow-md text-base-content rounded">
  <nav className="grid grid-flow-col gap-4">
  <NavLink to='/' className={({isActive, isPending}) => isActive? 'text-[#FF900E] underline' : isPending? 'pending' : ""}><li className="list-none">Home</li></NavLink>
...
<NavLink to='/events' className={({isActive, isPending}) => isActive? 'text-[#FF900E] underline' : isPending? 'pending' : ""}><li className="list-none">Contact us</li></NavLink>
  ...
  <aside>
    <p>Copyright © 2023 - All right reserved by social event managemen</p>
  </aside>
</footer>
